...
const register = asyncHandler(async (req, res, next) => {
  let { phoneNumber, type, password, userName, melliNumber } = req.body;
  let newUser
  let hashedPwd
  ...
  try {
    ...
    newUser = await userModel.create({ phoneNumber, type: type || 0, password: hashedPwd, companyNumber: userName }, { exclude: ["password"] });
